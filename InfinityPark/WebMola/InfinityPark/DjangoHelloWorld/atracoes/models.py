...
class AreaParque(models.Model):
    ...
    coordenadas_mapa = models.JSONField(default=dict)  # {x, y, width, height}
...
class Atracao(models.Model):
    ...
    galeria_imagens = models.JSONField(default=list)  # Lista de URLs
    
    # Localização no mapa
    coordenadas_mapa = models.JSONField(default=dict)  # {x, y}
    
    # Especificações da atração
    ...
    nivel_emocao = models.IntegerField(
        ...
        help_text="Nível de emoção de 1 a 5"
    )
