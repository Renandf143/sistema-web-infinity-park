...
def criar_avaliacoes_exemplo():
    ...
    avaliacoes = [
        {'atracao': 'Pirates of the Caribbean', 'nota': 5, 'comentario': 'Incrível! A ambientação é perfeita e os efeitos são impressionantes.'},
        {'atracao': 'Space Mountain', 'nota': 5, 'comentario': 'Emocionante do início ao fim! A escuridão torna tudo mais intenso.'},
        {'atracao': 'Splash Mountain', 'nota': 4, 'comentario': 'Muito divertido, mas prepare-se para se molhar completamente!'},
        {'atracao': 'Dragon\'s Fury', 'nota': 5, 'comentario': 'Para os amantes de adrenalina! Os loops são sensacionais.'},
        {'atracao': 'Castelo da Princesa', 'nota': 4, 'comentario': 'Minha filha adorou conhecer as princesas. Experiência mágica!'},
        {'atracao': 'Thunder Mountain Railroad', 'nota': 4, 'comentario': 'Ótima ambientação do velho oeste. Trilha sonora perfeita!'},
        {'atracao': 'Tower of Terror', 'nota': 5, 'comentario': 'Que susto! A queda livre é de tirar o fôlego.'},
        {'atracao': 'Jungle Cruise', 'nota': 3, 'comentario': 'Divertido, especialmente pelas piadas dos guias.'},
    ]
...
def main():
    """Função principal para executar toda a população do banco"""
    print("🎢 Iniciando população do banco de dados do Infinity Park...")
    print("=" * 60)
